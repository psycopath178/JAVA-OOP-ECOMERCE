...
public class InventoryDAO {
    ...
    // ===== Add a new product =====
    public boolean addInventory(Inventory s) {
        String sql = "INSERT INTO inventory_logs(name, category_id, brand_id, supplier_id, unit_id, cost, markup, price, quantity, date_added) " +
                     "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean updateInventory(Inventory p) {
        String sql = "UPDATE inventory_logs SET name=?, category_id=?, brand_id=?, supplier_id=?, unit_id=?, price=?, quantity=?, date_added=? " +
                     "WHERE id=?";
